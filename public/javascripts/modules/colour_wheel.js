    ...
    if(auto){
      ...
      $('.colorwell').each(function(rgb_hex){
        ...
        switch(swatch_id){
          ...
          case      'group_primary'      : hue_shift =  0.00; sat_shift =  0.00; lum_shift =  0.12; break;
          case      'group_secondary'    : hue_shift =  0.00; sat_shift =  0.00; lum_shift =  0.25; break;
          case      'group_tertiary'     : hue_shift =  0.00; sat_shift =  0.00; lum_shift =  0.50; break;
